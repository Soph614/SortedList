...
public class SortedListProjectGUI extends JFrame {
    ...
    public void createActionListeners() {
        ...
        enterDataTF.addActionListener((ActionEvent ae) -> {
            ...
            enterDataTF.setText("");
            list.add(userInput);
            listDisplayTA.append("Added '" + userInput + "' to the list.\n");
            displayList();
    ...
    public void createListDisplayPnl() {
        ...
        listDisplayTA = new JTextArea(20, 33);
    ...
    public void displayList() {
        listDisplayTA.append("------ LIST ------\n");
        listDisplayTA.append(list.getListContents());
        listDisplayTA.append("------------------\n\n");
    }
